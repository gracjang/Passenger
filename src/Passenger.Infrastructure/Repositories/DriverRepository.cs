...
namespace Passenger.Infrastructure.Repositories
{
  ...
  {
    private const string DriverCollectionName = "Drivers";
    ...
    public async Task<Driver> GetByIdAsync(Guid userId)
    ...
    private IMongoCollection<Driver> Drivers => _database.GetCollection<Driver>(DriverCollectionName);
  }
}